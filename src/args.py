...
def setup_parser() -> argparse.Namespace:
  ...
  parser.add_argument('--no-gui', action='store_true', help='do not open the gui window')
  parser.add_argument('--no-login', action='store_true', help='do not try to login into icloud')
